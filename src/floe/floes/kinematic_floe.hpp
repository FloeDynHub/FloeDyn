...
/*! Kinematic of a floe
 *
 * It depends on a the static of a floe.
 * His properties (frame, geometry, mesh) are defined with respect to the absolute frame and are updated at each state change.
 *
 * His movement is observable.
 *
